...
class EditWin(QWidget, Ui_Form):
    ...
    def init_connect(self):
        ...
        self.btn_3.clicked.connect(lambda: self.write_select('+25'))
        ...
        self.btn_8.clicked.connect(lambda: self.write_select('+100'))
        self.btn_9.clicked.connect(lambda: self.write_select('+100%'))
